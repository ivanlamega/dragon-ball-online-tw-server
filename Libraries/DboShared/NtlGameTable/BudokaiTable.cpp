...
//		Return	:
//-----------------------------------------------------------------------------------
bool CBudokaiTable::AddTable(void * pvTable, bool bReload)
{
...
//		Return	:
//-----------------------------------------------------------------------------------
bool CBudokaiTable::LoadFromBinary(CNtlSerializer& serializer, bool bReload)
{
	if( false == bReload )
	{
		Reset();
	...
	// sBUDOKAI_TBLINFO
//	if( serializer.GetDataSize() < sizeof(sBUDOKAI_TBLINFO))
//	{
//		return false;
//	}
//
//	serializer.Out( &m_sBudokaiTblInfo, sizeof(m_sBudokaiTblInfo));
