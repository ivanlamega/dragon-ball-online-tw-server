...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GN_NPC_SPAWN_REQ)
	sVECTOR3	vPlayerPos;
	sVECTOR3	vPlayerDir;
	TBLIDX		worldTblidx;
...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GN_MOB_SPAWN_REQ)
	sVECTOR3	vPlayerPos;
	sVECTOR3	vPlayerDir;
	TBLIDX		worldTblidx;
	HOBJECT		hPlayerHandle;
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GN_NPC_CHECK_REQ)
	sVECTOR3	vPlayerPos;
	sVECTOR3	vPlayerDir;
	TBLIDX		worldTblidx;
	HOBJECT		hPlayerHandle;
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GN_MOB_CHECK_REQ)
	sVECTOR3	vPlayerPos;
	sVECTOR3	vPlayerDir;
	TBLIDX		worldTblidx;
	HOBJECT		hPlayerHandle;
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GN_REFRESH_SERIAL)
	HOBJECT	hLastSerial;
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GN_ADMIN_MOB_SPAWN)
	HOBJECT	 hLastSerial;
	sVECTOR3 vPlayerPos;
	sVECTOR3 vPlayerDir;
	TBLIDX   mobID;
...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GN_ADMIN_NPC_SPAWN)
	HOBJECT	hLastSerial;
	sVECTOR3 vPlayerPos;
	sVECTOR3 vPlayerDir;
	TBLIDX   npcID;
...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GN_NPC_SHOP_BUY)
	HOBJECT				hPlayer;
	HOBJECT				handle;
	BYTE				byBuyCount;
