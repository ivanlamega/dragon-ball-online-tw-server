...
/*
	...
	2) Ranges that Op-code values belong to.
		...
		UA series packets' Op code should be in [100, 499].
		AU series packets' Op code should be in [1000, 1499].

		QA series packets' Op code should be in [500, 999].
		AQ series packets' Op code should be in [1500, 1999].
