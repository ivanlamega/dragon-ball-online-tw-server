...
//------------------------------------------------------------------
BEGIN_PROTOCOL(QG_HEARTBEAT)
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(QG_NOTIFY_CAN_LOAD_CHAR)
	ACCOUNTID			accountID;
	CHARACTERID			charID;
END_PROTOCOL()
//------------------------------------------------------------------
...
BEGIN_PROTOCOL(QG_PC_DATA_LOAD_RES)
	...
	//BYTE						byGMTResetCount;
	//BYTE						byPunishCount;
	//sPUNISH_DATA				asPunishData[GM_PUNISH_PASSIVE_TYPE_COUNT]; // MAX = GM_PUNISH_PASSIVE_TYPE_COUNT
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(QG_PC_ITEM_LOAD_RES)
	...
	CHARACTERID				charId;
	BYTE					byItemCount;
	sITEM_DATA				asItemData[NTL_MAX_COUNT_USER_HAVE_INVEN_ITEM]; // Max = NTL_MAX_COUNT_USER_HAVE_INVEN_ITEM
END_PROTOCOL()
//------------------------------------------------------------------
...
BEGIN_PROTOCOL(QG_PC_BUFF_LOAD_RES)
	...
	CHARACTERID				charId;
	BYTE					byBuffCount;
	sBUFF_DATA				asBuff[NTL_MAX_BLESS_BUFF_CHARACTER_HAS + NTL_MAX_CURSE_BUFF_CHARACTER_HAS]; // Max = NTL_MAX_BLESS_BUFF_CHARACTER_HAS + NTL_MAX_CURSE_BUFF_CHARACTER_HAS
END_PROTOCOL()
//------------------------------------------------------------------
...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(QG_PC_WAR_FOG_RES)
	WORD					wResultCode;
	ACCOUNTID				accountId;
	CHARACTERID				charId;
	sCHAR_WAR_FOG_FLAG		sWarFogInfo;
