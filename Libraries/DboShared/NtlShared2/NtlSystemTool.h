...
struct sCHARSEARCH_ENTITY
{
	...
	WCHAR			wszCharName[NTL_MAX_SIZE_CHAR_NAME_UNICODE + 1];	// Character Name
	BYTE			byLevel;
	BYTE			byRace;												// Race
	BYTE			byClass;											// Class
...
struct sPUNISHMENT_ENTITY
{
	...
	WCHAR					awchName[NTL_MAX_SIZE_CHAR_NAME_UNICODE + 1]; // [7/16/2008 SGpro]

	// Apply
	WCHAR					wszApplyTime[NTL_GM_TOOL_MAX_DATE_STRING_LENGTH];
	WCHAR				    wchApplyGMName[NTL_MAX_SIZE_CHAR_NAME_UNICODE + 1];	// GM Char Name
	BYTE					byPunishReason;
	WCHAR					wszPunishComment[NTL_MAX_PUNISH_REASON_LENGTH + 1];

	// Release
	WCHAR					wszReleaseTime[NTL_GM_TOOL_MAX_DATE_STRING_LENGTH];
	WCHAR				    wchReleaseGMName[NTL_MAX_SIZE_CHAR_NAME_UNICODE + 1];	// GM Char Name
	BYTE					byReleaseReason;
	WCHAR					wszReleaseComment[NTL_MAX_PUNISH_REASON_LENGTH + 1];
...
struct sGM_ENTITY
{
	...
	WCHAR					wszGMName[NTL_MAX_SIZE_CHAR_NAME_UNICODE + 1];// 대응 상황의 GM 이름
};
