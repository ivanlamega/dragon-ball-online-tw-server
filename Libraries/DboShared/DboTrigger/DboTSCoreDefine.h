...
#define HANDLE_TRIGGER_OBJECT_OFFSET 100000
...
enum eREWARD_SLOT_TYPE
{
	eREWARD_SLOT_TYPE_SELECTION,
	eREWARD_SLOT_TYPE_DEFAULT
};
...
enum eREWARD_TYPE
{
	...
	eREWARD_TYPE_GET_QUEST_REWARD_SELECT,
