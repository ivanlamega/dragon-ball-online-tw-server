...
/**
	...
	용도 : Client quest, server quest
	설명 : 서버에서 주기적으로 eSTOC_EVT_TYPE에 해당하는 메시지를 내려준다
		   클라이언트는 해당 정보를 화면에 출력하기 위한 준비를 한다
*/


class CDboTSActSToCEvt : public CNtlTSAction
{
	NTL_TS_DECLARE_RTTI(CDboTSActSToCEvt, CNtlTSAction)
