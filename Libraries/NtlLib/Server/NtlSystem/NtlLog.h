...
//
//-----------------------------------------------------------------------------------
class CNtlLogStream_FilePtr : public CNtlLogStream
{
friend class CNtlLog;

public:

	CNtlLogStream_FilePtr(FILE *fp):m_fp(fp) {}

	virtual ~CNtlLogStream_FilePtr() {}
...
public:
	...
	int					AttachLogStream(CNtlLogStream & rLogStream);
