========================================================================
    콘솔 응용 프로그램 : NtlClientNet 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 NtlClientNet 응용 프로그램을 만들었습니다.  
이 파일에는 NtlClientNet 응용 프로그램을 구성하는 각각의 파일에
...
StdAfx.h 및 StdAfx.cpp는
    NtlClientNet.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
