...
{
    return mesh.vertColArray[colourIndex0].x == r
        && mesh.vertColArray[colourIndex0].y == g
        && mesh.vertColArray[colourIndex0].z == b
        && mesh.vertColArray[colourIndex1].x == r
        && mesh.vertColArray[colourIndex1].y == g
        && mesh.vertColArray[colourIndex1].z == b
        && mesh.vertColArray[colourIndex2].x == r
        && mesh.vertColArray[colourIndex2].y == g
        && mesh.vertColArray[colourIndex2].z == b
        ;
}
...
{
    float g = mesh.vertColArray[colourIndex0].y;
    if(g == 0.f)
    {
        return false;
    }
    if(mesh.vertColArray[colourIndex0].x == r
        && mesh.vertColArray[colourIndex0].z == b
        && mesh.vertColArray[colourIndex1].x == r
        && mesh.vertColArray[colourIndex1].y == g
        && mesh.vertColArray[colourIndex1].z == b
