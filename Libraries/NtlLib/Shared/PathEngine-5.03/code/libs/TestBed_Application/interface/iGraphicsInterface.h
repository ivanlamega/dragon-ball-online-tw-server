...
public:
    ...
    virtual iRenderGeometry* newText_8By16(long x, long y, const char* str, cGeometrySet* set = 0)=0;
    virtual long loadImage(const char* fileName)=0;
    virtual iRenderGeometry* newSplashImage(long x, long y, long loadedImageIndex, cGeometrySet* set = 0)=0;
    virtual iRenderGeometry* newSplashImage(long loadedImageIndex, cGeometrySet* set = 0)=0;
