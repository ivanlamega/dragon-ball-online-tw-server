...
// iGraphicsInterface
    ...
    iRenderGeometry* newText_8By16(long x, long y, const char* str, cGeometrySet* set)
    {
        assertD(set == 0);
    ...
    iRenderGeometry* newSplashImage(long x, long y, long loadedImageIndex, cGeometrySet* set)
    {
        assertD(set == 0);
        _vector.push_back(_base->newSplashImage(x, y, loadedImageIndex, _set));
        return 0;
    }
    iRenderGeometry* newSplashImage(long loadedImageIndex, cGeometrySet* set)
    {
        assertD(set == 0);
