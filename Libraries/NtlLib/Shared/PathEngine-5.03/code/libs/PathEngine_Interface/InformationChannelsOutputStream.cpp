...
void
cInformationChannelsOutputStream::addAttribute(const char* attribute, long value)
{
    _base.addAttribute(attribute, value);
}
void
cInformationChannelsOutputStream::addAttribute(const char* attribute, unsigned long value)
{
    _base.addAttribute(attribute, value);
}
void
