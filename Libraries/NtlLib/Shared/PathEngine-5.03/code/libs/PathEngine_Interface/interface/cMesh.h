...
//    std::vector<cHandle<cShape> > _baseObstacleHeldShapes;
    ...
    std::vector<std::string> _obstructionIDs;
//    std::vector<cHandle<cShape> > _obstructionHeldShapes;
    std::vector<cCollisionShape> _obstructionShapes;
    std::vector<cObstacleInfo> _obstructions;
...
//    }
    ...
    const std::vector<cObstacleInfo>& refBaseObstacles() const
    {
        return _baseObstacles;
    }
    const std::vector<cCollisionShape>& refBaseObstacleShapes() const
    {
