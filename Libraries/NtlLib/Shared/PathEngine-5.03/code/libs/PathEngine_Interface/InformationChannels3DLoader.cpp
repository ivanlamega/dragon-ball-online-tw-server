...
void
cInformationChannels3DLoader::processFaceAttributes(long faceIndex, const char *const* attributes)
{
    long value;
    ...
    if(value)
    {
        ...
        {
        // create the channel
            _surfaceTypes = new std::vector<long>(_facesIn3DMesh, 0);
        }
    ...
    if(value != -1)
    {
        ...
        {
        // create the channel
            _sectionIDs = new std::vector<long>(_facesIn3DMesh, -1);
        }
    ...
    if(value)
    {
        ...
        {
        // create the channel
            _userData = new std::vector<long>(_facesIn3DMesh, 0);
        }
