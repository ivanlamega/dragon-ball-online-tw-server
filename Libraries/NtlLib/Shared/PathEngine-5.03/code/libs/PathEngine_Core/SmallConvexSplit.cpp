        ...
        )
{
    ...
    for(long i = 0; i != SizeL(baseObstacleExpansions); ++i)
    {
        if(_isSmallConvex[i])
        {
...
//
//            for(long i = 0; i != _smallConvexOnOriginal->size(); ++i)
//            {
        ...
        )
{
    ...
    for(long i = 0; i != SizeL(baseObstacleExpansions); ++i)
    {
        ...
        if(!shape.satisfiesMaxCircumference(maxCircumference))
        {
            continue;
        }
        ...
        )
{
    ...
    do
    {
        ...
        if(nextElement && strcmp(nextElement, "isSmallConvex") == 0)
        {
            ...
            long index = ValueAsLong(attributes, "index");
