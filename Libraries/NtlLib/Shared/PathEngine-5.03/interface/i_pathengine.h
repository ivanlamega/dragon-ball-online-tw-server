...
#ifndef UNREFERENCED_PARAMTER
#define UNREFERENCED_PARAMTER( VAL ) ((void)VAL)
#endif //UNREFERENCED_PARAMTER

const long PATHENGINE_INTERFACE_MAJOR_VERSION = 2;
const long PATHENGINE_INTERFACE_MINOR_VERSION = 44;
...
class iPathEngine
{
    void operator delete(void* voidPointer) { UNREFERENCED_PARAMTER( voidPointer ); }
public:
...
{
public:
    void put(const char* data, unsigned long dataSize) { UNREFERENCED_PARAMTER( data ); UNREFERENCED_PARAMTER( dataSize ); }
};
#endif
