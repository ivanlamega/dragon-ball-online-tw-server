...
#ifndef ___C_NAV_AREA_H___
#define ___C_NAV_AREA_H___
...
class CNavArea : public CNavEntity
{
	...
	protected:
		...
		inline							CNavArea( UId32 nUniqueId ) : CNavEntity( nUniqueId ) { Initialize(); m_eType = E_NAV_ENTITY_TYPE_AREA; }

		inline							~CNavArea( void ) { Destroy(); }

	private:

										CNavArea( void );
										CNavArea( const CNavArea & rcArea );

		const CNavArea &				operator =( const CNavArea & rcArea );
...
//=============================================================================
// End of Class : CNavArea
//=============================================================================

END_NAMESPACE( nav )

#endif //___C_NAV_AREA_H___

//*****************************************************************************
//
// End of File : CNavArea.h
//
//*****************************************************************************