...
namespace nVectorMesh_Internal
{
    ...
    public:
        ...
        void
        remap(const long* edgeRemaps)
        {
            assertD(!isDead());
            firstEdge = edgeRemaps[firstEdge];
        }
        void
        offset(long edgeOffset)
        {
            assertD(!isDead());
    ...
    public:
        ...
        void
        remap(  const long* faceRemaps,
                const long* edgeRemaps,
                const long* vertRemaps
                )
        {
            assertD(!isDead());
        ...
        void
        remapFace(const long* faceRemaps)
        {
            assertD(!isDead());
            face = faceRemaps[face];
        }
        void
        remapVert(const long* vertRemaps)
        {
            assertD(!isDead());
            vert = vertRemaps[vert];
        }
        void
        offset( long faceOffset,
                long edgeOffset,
                long vertOffset
                )
        {
