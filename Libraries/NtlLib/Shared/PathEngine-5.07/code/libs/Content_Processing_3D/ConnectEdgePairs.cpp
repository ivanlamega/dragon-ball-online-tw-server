...
//        tMesh_Dynamic& mesh,
//        tEdge_Dynamic e,
//        tEdge_Dynamic* vertsPtr, long verts
//        )
//{
...
Update_E1StartMatchesE2End(
        ...
        tEdge_Dynamic*& edgesPtr1, long& edges1,
        tEdge_Dynamic*& edgesPtr2, long& edges2
        )
{
...
// note that this will be rounded down in the case where all pairs for the last entry encountered have been discarded
    ...
    long pairs = SizeL(edgesPerIndex) / 2;
