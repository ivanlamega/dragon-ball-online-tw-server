...
//inline void
//StoreSideOfPlane(cBitVector& bitVector, long startPosition, long index, eSideOfPlane side)
//{
...
inline eSideOfPlane
RetrieveSideOfPlane(const cBitVector& bitVector, long startPosition, long index)
{
