...
class cPathSegmentInterpolator
{
    ...
    long interpolatorValueAtPoint(const tPoint& p) const;
    long otherAxisValueAtPoint(const tPoint& p) const;
    tPoint pointFor(long interpolatorValue, long otherAxisValue) const;
...
public:
    ...
    long segmentLength() const;
    long interpolatorMax() const;
    ...
    void interpolate(const tPoint& currentPosition, long interpolatorTarget, bool& exactlyOnLine, tPoint& point1, tPoint& point2) const;
};
