...
void
AddAnchorsAndPinnedShapes(iPathEngine& pathEngine, iMesh* mesh, const iAnchorsAndPinnedShapes& anchorsAndShapes, const char* idPrefix, long numberOfTerrainLayers);
