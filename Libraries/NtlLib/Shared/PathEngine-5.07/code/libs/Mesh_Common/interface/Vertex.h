...
//template <class T, class P>
//T TraverseFromVertex(const T vertex, const P& target, long target_spin_count)
//{
...
//        {
//            long actual_spin_count = spin_count;
...
TraverseFromVertex_Elements(const typename tMesh::vertex v, const tPointLike& target, long targetSpinCount)
{
