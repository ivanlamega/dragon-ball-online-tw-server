...
{
    const long sizes[] = {0, 5, 4, 2, 1, 4, 2, 1};
    return sizes[type];
}

static char
SmallestTypeFor(long value)
{
    char result = 2;
...
static char
SmallestTypeFor(unsigned long value)
{
    char result = 5;
    if(value <= 0xffffUL)
    {
...
static void
OutputAsType(long value, char type, iOutputStream& os)
{
    char asBytes[4];
    switch(type)
    {
    ...
    case 4:
        ...
        break;
    case 5:
        UnsignedToByteBuffer(static_cast<unsigned long>(value), 4, asBytes);
        os.put(asBytes, 4);
        break;
    case 6:
        UnsignedToByteBuffer(static_cast<unsigned long>(value), 2, asBytes);
        os.put(asBytes, 2);
        break;
//    case 8:
...
static void
OutputAsType(unsigned long value, char type, iOutputStream& os)
{
    char asBytes[4];
    switch(type)
    {
    ...
    case 1:
        ...
        break;
    case 2:
        SignedToByteBuffer(static_cast<long>(value), 4, asBytes);
        os.put(asBytes, 4);
        break;
    case 3:
        SignedToByteBuffer(static_cast<long>(value), 2, asBytes);
        os.put(asBytes, 2);
        break;
    case 5:
...
//        break;
//    case 4:
//        SignedToByteBuffer(static_cast<long>(value), 1, asBytes);
//        os.put(asBytes, 1);
//        break;
//    case 6:
//        UnsignedToByteBuffer(static_cast<unsigned long>(value), 2, asBytes);
...
//        break;
//    case 7:
//        UnsignedToByteBuffer(static_cast<unsigned long>(value), 1, asBytes);
//        os.put(asBytes, 1);
//        break;
//    case 8:
//        FloatToByteBuffer(static_cast<float>(value), asBytes);
...
void
cElementAndAttributeEnumerator::addAttribute(const char* attribute, long value)
{
    char type = SmallestTypeFor(value);
    AddOrUpdateAttributeAndType(attribute, type);
}
void
cElementAndAttributeEnumerator::addAttribute(const char* attribute, unsigned long value)
{
    char type = SmallestTypeFor(value);
    AddOrUpdateAttributeAndType(attribute, type);
}
...
void
cTokenisedXMLOutputStream::addAttribute(const char* attribute, long value)
{
    assertD(!_attributeListClosed);
    char index = GetIndexFor(_enumerator._attributes, attribute);
    _os << index;
...
void
cTokenisedXMLOutputStream::addAttribute(const char* attribute, unsigned long value)
{
    assertD(!_attributeListClosed);
    char index = GetIndexFor(_enumerator._attributes, attribute);
    _os << index;
