...
void
cCornerProvider::save(long numberToSave, iXMLOutputStream& os) const
{
    long i;
...
bool
cCornerProvider::operator()(long lhsIndex, long rhsIndex) const
{
