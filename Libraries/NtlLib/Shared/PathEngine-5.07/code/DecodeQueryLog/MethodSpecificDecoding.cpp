        ...
        case 21:
            {
                ...
                if(methodEntry)
                {
                    ...
                    decoder.decode_long("tileSize");
                    decoder.decode_long("overlap");
                }
                else
                {
                    decoder.decodeAPIObject("returnValue");
        ...
        case 25:
            {
                ...
                {
                    decoder.decode_const_long_star("point");
                    decoder.decode_long("numberOfTerrainLayers");
                }
                else
                {
                    decoder.decode_cPosition("returnValue");
        ...
        case 78:
            {
                ...
                if(methodEntry)
                {
                    ...
                    decoder.decode_long("startVectorX");
                    decoder.decode_long("startVectorY");
                    decoder.decode_long("endVectorX");
                    decoder.decode_long("endVectorY");
                    decoder.decode_long("sectionLength");
                    decoder.decode_float("turnRatio1");
                    decoder.decode_float("turnRatio2");
                }
        ...
        case 7:
            {
                ...
                if(methodEntry)
                {
                    decoder.decode_long("connectingEdgeIndex");
                }
                else
                {
        ...
        case 8:
            {
                ...
                if(methodEntry)
                {
                    decoder.decode_long("connectingEdgeOnThis");
                    decoder.decodeAPIObject("targetInstance");
                    decoder.decode_long("connectingEdgeOnTarget");
                }
                else
                {
                    decoder.decode_bool("returnValue");
        ...
        case 4:
            {
                ...
                if(methodEntry)
                {
                    decoder.decode_long("queryStartX");
                    decoder.decode_long("queryStartY");
                }
                else
                {
                    decoder.decode_long("returnValue");
        ...
        case 5:
            {
                ...
                if(methodEntry)
                {
                    decoder.decode_long("tileIndex");
                }
                else
                {
                    decoder.decode_long("centreX");
                    decoder.decode_long("centreY");
                }
                break;
            }
        case 6:
        ...
        case 10:
            {
                ...
                if(methodEntry)
                {
                    decoder.decode_long("fromTileIndex");
                    decoder.decodeAPIObject("fromMesh");
                    decoder.decode_long("toTileIndex");
