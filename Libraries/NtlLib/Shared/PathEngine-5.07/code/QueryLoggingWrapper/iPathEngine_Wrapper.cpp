...
iMeshFederation*
iPathEngine_Wrapper::buildMeshFederation_FromWorldMesh(const iMesh* worldMesh, long tileSize, long overlap, iMeshFederationTileGeneratedCallBack& tileGeneratedCallBack)
{
    unsigned long queryCount = gLogger.methodEntry(0, 21, (void*)this);
...
iMeshFederation*
iPathEngine_Wrapper::loadFederation(const char* format, const char* dataBuffer, unsigned long bufferSize)
{
    unsigned long queryCount = gLogger.methodEntry(0, 22, (void*)this);
    gLogger.log(format);
    gLogger.logDataBuffer(dataBuffer, bufferSize);
    gLogger.methodEntry_Completed();
...
iMeshFederation*
iPathEngine_Wrapper::buildMeshFederation_TilingOnly(const cHorizontalRange& worldRange, long tileSize, long overlap)
{
    unsigned long queryCount = gLogger.methodEntry(0, 23, (void*)this);
