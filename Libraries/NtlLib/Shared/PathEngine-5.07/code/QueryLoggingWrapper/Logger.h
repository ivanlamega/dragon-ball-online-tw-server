...
public:
    ...
    void logContentChunkInstanceVector(const iContentChunkInstance* const* instancePointers, long numberOfInstances);
    void logLongVector(long* resultsBuffer, long& numberOverlapped);
};
