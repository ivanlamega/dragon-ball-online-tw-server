...
const long PATHENGINE_INTERFACE_MAJOR_VERSION = 3;
const long PATHENGINE_INTERFACE_MINOR_VERSION = 0;
...
public:
    ...
    virtual iMeshFederation* buildMeshFederation_TilingOnly(const cHorizontalRange& worldRange, long tileSize, long overlap) = 0;
};
...
public:
    ...
    virtual cPosition positionFor3DPoint_ExcludeTerrain(const long* point, long numberOfTerrainLayers) const = 0;
...
public:
    ...
    virtual iContentChunkInstance* instantiate(long rotation, long scale, long translationX, long translationY, float translationZ, long sectionID) = 0;
    virtual iContentChunkInstance* instantiate_FloatRotateAndScale(float rotation, float scale, long translationX, long translationY, float translationZ, long sectionID) = 0;
    ...
    virtual long numberOfConnectingEdges() const = 0;
    void operator delete(void* voidPointer)
    {
        if(voidPointer)
        {
...
public:
    ...
    virtual void addAnchorsAndShapes(iMesh* mesh, const char* idPrefix, long numberOfTerrainLayers) const = 0;
    virtual void getHorizontalRange(cHorizontalRange& result) const = 0;
    virtual long numberOfConnectingEdges() const = 0;
    virtual void getConnectingEdgeGeometry(long connectingEdgeIndex, long& startX, long& startY, float& startZ, long& endX, long& endY, float& endZ) const = 0;
    virtual bool edgesCanConnect(long connectingEdgeOnThis, iContentChunkInstance* targetInstance, long connectingEdgeOnTarget) const = 0;
    virtual void makeEdgeConnection(long connectingEdgeOnThis, iContentChunkInstance* targetInstance, long connectingEdgeOnTarget) const = 0;
    void operator delete(void* voidPointer)
    {
        if(voidPointer)
        {
...
public:
    ...
    virtual void getHandledRegion_World(long tileIndex, cHorizontalRange& result) const = 0;
    virtual void getRepresentedRegion_World(long tileIndex, cHorizontalRange& result) const = 0;
    virtual void getHandledRegion_Local(long tileIndex, cHorizontalRange& result) const = 0;
    virtual void getRepresentedRegion_Local(long tileIndex, cHorizontalRange& result) const = 0;
    ...
    virtual void getRepresentedRegionsOverlapped(const cHorizontalRange& queryRegion, long* resultsBuffer, long& numberOverlapped) const = 0;
    virtual iMesh* buildTileMeshFromContent(long tileIndex, const iContentChunkInstance* const* instancePointers, long numberOfInstances, const char *const* options, iOutputStream* os) = 0;
    void operator delete(void* voidPointer)
    {
        if(voidPointer)
        {
