...
//  [5/20/2008 zeroera] : 추가
extern "C" 
{
	#include "../Lua-5.1.0/src/lua.h"
	#include "../Lua-5.1.0/src/lualib.h"
	#include "../Lua-5.1.0/src/lauxlib.h"
};
...
namespace lua_tinker
{
	...
	void	set_print_stream(FILE * stream); //  [5/20/2008 zeroera] : 추가
