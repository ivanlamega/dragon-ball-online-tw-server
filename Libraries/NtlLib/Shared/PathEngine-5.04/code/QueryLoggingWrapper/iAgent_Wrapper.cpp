...
{
    unsigned long queryCount = gLogger.methodEntry(3, 0, (void*)this);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 1, (void*)this);
    gLogger.methodEntry_Completed();
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 2, (void*)this);
    gLogger.methodEntry_Completed();
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 3, (void*)this);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 4, (void*)this);
    gLogger.methodEntry_Completed();
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 5, (void*)this);
    gLogger.methodEntry_Completed();
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 6, (void*)this);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 7, (void*)this);
    gLogger.methodEntry_Completed();
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 8, (void*)this);
    gLogger.methodEntry_Completed();
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 9, (void*)this);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 10, (void*)this);
    gLogger.log((void*)context);
    gLogger.log(newPosition);
    gLogger.methodEntry_Completed();
...
bool
iAgent_Wrapper::testCollisionTo_XY(iCollisionContext* context, long x, long y, long& cell) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 11, (void*)this);
    gLogger.log((void*)context);
    gLogger.log(x);
    gLogger.log(y);
    gLogger.methodEntry_Completed();
...
iCollisionInfo*
iAgent_Wrapper::firstCollisionTo(iCollisionContext* context, long x, long y, long& cell) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 12, (void*)this);
    gLogger.log((void*)context);
    gLogger.log(x);
    gLogger.log(y);
    gLogger.methodEntry_Completed();
...
cPosition
iAgent_Wrapper::findClosestUnobstructedPosition(iCollisionContext* context, long maximumDistance) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 13, (void*)this);
    gLogger.log((void*)context);
...
void
iAgent_Wrapper::getAllAgentsOverlapped(iCollisionContext* context, iAgent** resultsBuffer, long& numberOverlapped) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 14, (void*)this);
    gLogger.log((void*)context);
    gLogger.methodEntry_Completed();
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 15, (void*)this);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 16, (void*)this);
    gLogger.log((void*)context);
    gLogger.log(target);
    gLogger.methodEntry_Completed();
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 17, (void*)this);
    gLogger.log((void*)context);
    gLogger.log(target);
...
iPath*
iAgent_Wrapper::findPathAway(iCollisionContext* context, const cPosition& awayFrom, long distanceAway) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 18, (void*)this);
    gLogger.log((void*)context);
...
iPath*
iAgent_Wrapper::findPathAway_WithQueryCallBack(iCollisionContext* context, const cPosition& awayFrom, long distanceAway, iQueryCallBack* queryCallBack) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 19, (void*)this);
    gLogger.log((void*)context);
    gLogger.log(awayFrom);
    gLogger.log(distanceAway);
    gLogger.log((void*)queryCallBack);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 20, (void*)this);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 21, (void*)this);
    gLogger.log((void*)path);
    gLogger.log(distance);
    gLogger.log((void*)context);
    gLogger.methodEntry_Completed();
...
iPath*
iAgent_Wrapper::generateCurvedPath(iPath* basePath, iCollisionContext* context, long startVectorX, long startVectorY, long sectionLength, float turnRatio1, float turnRatio2) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 22, (void*)this);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 23, (void*)this);
    gLogger.log(cost);
    gLogger.methodEntry_Completed();
...
void
iAgent_Wrapper::setTraverseCostDirection(long directionVectorX, long directionVectorY)
{
    unsigned long queryCount = gLogger.methodEntry(3, 24, (void*)this);
...
{
    unsigned long queryCount = gLogger.methodEntry(3, 25, (void*)this);
    gLogger.methodEntry_Completed();
...
void
iAgent_Wrapper::getTraverseCostDirection(long& directionVectorX, long& directionVectorY) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 26, (void*)this);
    gLogger.methodEntry_Completed();
...
iPath*
iAgent_Wrapper::generateCurvedPath_WithEndVector(iPath* basePath, iCollisionContext* context, long startVectorX, long startVectorY, long endVectorX, long endVectorY, long sectionLength, float turnRatio1, float turnRatio2) const
{
    unsigned long queryCount = gLogger.methodEntry(3, 27, (void*)this);
    gLogger.log((void*)basePath);
    gLogger.log((void*)context);
    gLogger.log(startVectorX);
    gLogger.log(startVectorY);
