...
static void
SelectFace(Interface* ip, std::string nodeName, long faceIndex)
{
    std::ostringstream s;
    s << "setFaceSelection $'";
    s << nodeName;
...
static void
SelectFaces(Interface* ip, std::string nodeName, const std::vector<long>& faces)
{
    std::ostringstream s;
    s << "setFaceSelection $'";
    s << nodeName;
...
static void
SelectVertices(Interface* ip, std::string nodeName, const std::vector<long>& vertices)
{
    std::ostringstream s;
    s << "setVertSelection $'";
    s << nodeName;
