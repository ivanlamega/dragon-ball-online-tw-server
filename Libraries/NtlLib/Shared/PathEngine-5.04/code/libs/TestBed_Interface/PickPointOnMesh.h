        ...
        )
{
    ...
    p = tPoint(static_cast<long>(approximatePoint.x()), static_cast<long>(approximatePoint.y()), WORLD_RANGE + 2);
    ...
    p=tPoint(static_cast<long>(approximatePoint.x()) + 1, static_cast<long>(approximatePoint.y()), WORLD_RANGE + 2);
    if(PointIsInFace<tMesh_3D>(f, p))
    {
        fIndex2D = translation.translate(f, p).index();
        result.x = p.getX();
    ...
    p=tPoint(static_cast<long>(approximatePoint.x()), static_cast<long>(approximatePoint.y()) + 1,WORLD_RANGE + 2);
    if(PointIsInFace<tMesh_3D>(f, p))
    {
        fIndex2D = translation.translate(f, p).index();
        result.x = p.getX();
