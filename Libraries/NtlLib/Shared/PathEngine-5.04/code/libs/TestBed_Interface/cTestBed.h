...
class cTestBed : public iTestBed
{
    ...
    long _cachedBoundsMinX;
    long _cachedBoundsMinY;
    long _cachedBoundsMaxX;
    long _cachedBoundsMaxY;
    cGraphicsInterfaceRecorder* _cachedBounds;
    bool _cachedBounds2Valid;
    long _cachedBounds2MinX;
    long _cachedBounds2MinY;
    long _cachedBounds2MaxX;
    long _cachedBounds2MaxY;
    cGraphicsInterfaceRecorder* _cachedBounds2;
...
// iTestBed
    ...
    void drawRangeBounds(long minX, long minY, long maxX, long maxY);
