...
#ifndef PLACED_CONVEX_SHAPE_INCLUDED
#define PLACED_CONVEX_SHAPE_INCLUDED
...
public:
    ...
    // start and end are inclusive for these
//    bool lineCollides2D_Old(const tLine& l, long& collidingLineIndex) const;
//    bool lineCollides2D_New(const tPoint& lineStart, const tPoint& lineAxis, long& collidingLineIndex) const;
...
//    cPlacedConvexShape(std::vector<tPoint>& points); // the contents of the vector are swapped in
