...
iPath*
cAgent::generateCurvedPath_WithEndVector(iPath* basePath, iCollisionContext* context, long startVectorX, long startVectorY, long endVectorX, long endVectorY, long sectionLength, float turnRatio1, float turnRatio2) const
{
    return _mesh->generateCurvedPath_WithEndVector(
        _shape.get(), basePath, context,
        startVectorX, startVectorY,
