...
iRenderGeometry*
cGraphicsInterface::newText_8By16(long x, long y, const char* str, cGeometrySet* set)
{
...
iRenderGeometry*
cGraphicsInterface::newSplashImage(long x, long y, long loadedImageIndex, cGeometrySet* set)
{
    long width, height;
...
iRenderGeometry*
cGraphicsInterface::newSplashImage(long loadedImageIndex, cGeometrySet* set)
{
