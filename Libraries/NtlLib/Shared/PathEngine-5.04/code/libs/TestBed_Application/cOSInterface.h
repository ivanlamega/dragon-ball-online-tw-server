...
{
    long _windowSizeX, _windowSizeY;
...
public:
    ...
    void setWindowSize(long sizeX, long sizeY);
...
// interface
	...
	long __stdcall getwinx();
	long __stdcall getwiny();
	...
	void __stdcall sleep(long milliseconds);
};
