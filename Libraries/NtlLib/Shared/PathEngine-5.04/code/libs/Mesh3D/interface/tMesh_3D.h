...
{
    return tPoint3(e.vertex()->_x, e.vertex()->_y, static_cast<long>(e->_z), WORLD_RANGE);
}
...
inline cE3D MakeEdge(tMesh_3D::edge e, const tLine &l)
{
    return *e;
}
...
inline cE3D MakeEdge(tMesh_3D_FaceTracked::edge e, const tLine &l)
{
    return *e;
}
