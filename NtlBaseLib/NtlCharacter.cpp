...
void CopyCharState( sCHARSTATE* pDest, const sCHARSTATE* pSrc )
{
	...
	{
		pDest->sCharStateDetail.sCharStateAirJump = pSrc->sCharStateDetail.sCharStateAirJump;
	}
	break;
	case CHARSTATE_AIR_DASH_ACCEL:
	{
		pDest->sCharStateDetail.sCharStateAirDashAccel = pSrc->sCharStateDetail.sCharStateAirDashAccel;
	}
	break;
	}
}
