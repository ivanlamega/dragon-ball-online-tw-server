...
struct sBUDOKAI_REGISTER_TEAM_DATA : public sBUDOKAI_REGISTER_DATA
{
	...
	CHARACTERID				aMembers[MAX_MEMBER_IN_PARTY];
};
...
struct sBUDOKAI_TOURNAMENT_TEAM_ENTRY_DATA : public sBUDOKAI_TOURNAMENT_ENTRY_DATA
{
	WCHAR			wszTeamName[MAX_LENGTH_BUDOKAI_TEAM_NAME_IN_UNICODE + 1];
	BYTE			byMemberCount;
	sBUDOKAI_TOURNAMENT_TEAM_ENTRY_MEMBER_DATA	aMembers[MAX_MEMBER_IN_PARTY];
};
...
{
	CHARACTERID		charId;
	WORD			wCharName;				//WCHAR			wszCharName[MAX_SIZE_CHAR_NAME_UNICODE + 1];
	BYTE			byClass;
	BYTE			byLevel;
	float			fRankPoint;
	...
	WORD			wRankBattleDrawCount;
	WORD			wRankBattleLoseCount;
	WORD			wGuildName;				//WCHAR			wszGuildName[MAX_SIZE_GUILD_NAME_IN_UNICODE + 1];
};
...
{
	WORD			wTeamName;				//WCHAR			wszTeamName[MAX_LENGTH_BUDOKAI_TEAM_NAME_IN_UNICODE + 1];
	BYTE			byMemberCount;
	WORD			wMembers;				//sBUDOKAI_TOURNAMENT_TEAM_ENTRY_MEMBER_DATA	aMembers[MAX_MEMBER_IN_PARTY];
};
...
struct sBUDOKAI_REGISTER_TEAM_INFO
{
	...
	sBUDOKAI_TEAM_POINT_INFO	aMemberInfo[MAX_MEMBER_IN_PARTY];
};
...
{
	BYTE		byCount;
	CHARACTERID	charId[MAX_MEMBER_IN_PARTY];
};
...
struct sBUDOKAI_GM_MATCH_PROGRESS_STATE
{
	...
	// Team1
	WCHAR		wszTeamName1[MAX_LENGTH_BUDOKAI_TEAM_NAME_IN_UNICODE + 1];
	BYTE		byScore1;

	// Team2
	WCHAR		wszTeamName2[MAX_LENGTH_BUDOKAI_TEAM_NAME_IN_UNICODE + 1];
	BYTE		byScore2;
};
