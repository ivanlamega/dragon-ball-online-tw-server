...
{
	static float s_afChainAttackBonusRate[ BATTLE_MAX_CHAIN_ATTACK_COUNT ] = { 0.0f, 0.05f, 0.10f, 0.20f, 0.30f, 0.40f };
	...
	if( byAttackSequence > BATTLE_MAX_CHAIN_ATTACK_COUNT )
	{
		_ASSERT( 0 );
		return 0.0f;
	}
