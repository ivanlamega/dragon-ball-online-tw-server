...
BEGIN_SVR_RELAY_DATA( G2G_BUDOKAI_PRIZEWINNER_NAME_RES )
	...
	WCHAR						wszWinner[MAX_SIZE_CHAR_NAME_UNICODE + 1];
	WCHAR						wszSecondWinner[MAX_SIZE_CHAR_NAME_UNICODE + 1];

	WCHAR						wszWinnerTeam[MAX_LENGTH_BUDOKAI_TEAM_NAME_IN_UNICODE + 1];
	WCHAR						wszSecondWinnerTeam[MAX_LENGTH_BUDOKAI_TEAM_NAME_IN_UNICODE + 1];
END_SVR_RELAY_DATA()
//---------------------------------------------------------------------------------------
