/*
 ...
 Source Schema         : dbotw2

 Target Server Type    : MySQL
 Target Server Version : 100313
 File Encoding         : 65001

 Date: 09/03/2020 10:26:43
*/
...
CREATE TABLE `aucionhouse`  (
  ...
  `ItemHandle` int(11) NULL DEFAULT NULL,
  `SellerName` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ItemTblidx` int(11) NULL DEFAULT NULL,
  `SellAmount` int(11) NULL DEFAULT NULL,
  `StackCount` int(11) NULL DEFAULT NULL,
  `ItemLevel` int(11) NULL DEFAULT NULL,
  `ItemType` int(11) NULL DEFAULT NULL,
  `ItemGrade` int(11) NULL DEFAULT NULL,
  `ItemRank` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `banlist`  (
  ...
  `Rason` varchar(160) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE = MyISAM AUTO_INCREMENT = 200 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `characters`  (
  ...
  `CashPoint` int(10) NULL DEFAULT 999999,
...
CREATE TABLE `friendlist`  (
  ...
  `IsBlack` tinyint(1) NULL DEFAULT 0 COMMENT 'is in the black list?',
  PRIMARY KEY (`FriendID`) USING BTREE COMMENT 'Friend ID',
  INDEX `CharID`(`CharID`) USING BTREE,
  INDEX `friendlist_ibfk_1`(`OwnerID`) USING BTREE,
  CONSTRAINT `friendlist_ibfk_1` FOREIGN KEY (`OwnerID`) REFERENCES `characters` (`CharacterID`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE `guilds`  (
  ...
  `GuildFunctions` int(15) NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for htb
-- ----------------------------
DROP TABLE IF EXISTS `htb`;
CREATE TABLE `htb`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `htb_id` int(11) NULL DEFAULT NULL,
  `owner_id` int(11) NULL DEFAULT NULL,
  `TimeRemaining` int(15) NULL DEFAULT NULL,
  `SlotID` smallint(3) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `items`  (
  ...
  INDEX `owner_id_idx`(`owner_id`) USING BTREE,
  INDEX `item_vnum_index`(`tblidx`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 269761 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `mail`  (
  ...
  `tCreateTime` int(50) NULL DEFAULT NULL,
  ...
  `StackCount` int(10) NULL DEFAULT 1,
...
CREATE TABLE `portals`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 542 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `realmlist`  (
  ...
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '45.236.129.159',
  `Port` int(255) NULL DEFAULT 50200,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `skills`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4204 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
